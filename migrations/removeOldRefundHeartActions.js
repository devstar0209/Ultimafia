...
async function migrate() {
  try {
    ...
    logger.info(
      `Total actions to delete: ${redHeartActions + goldHeartActions}`
    );
    ...
    logger.warn(
      "This will permanently delete these mod actions from the database."
    );
    logger.warn(
    ...
    logger.info(
      `Successfully deleted ${deleteResult.deletedCount} mod actions`
    );

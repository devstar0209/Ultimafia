# PassionMafia Ultimate Setup and Beginner Contribution Guide
...
<img src="https://github.com/PassionMafia/PassionMafia/assets/24848927/813494b6-1550-4ec4-9669-dc7d319cc974" alt="codespace billing" width="700"/>
...
<img src="https://github.com/PassionMafia/PassionMafia/assets/24848927/9fab3e1a-9313-4caf-b0a2-c6242773616b" alt="open in desktop" width="300"/>
...
```
cp docs/server_env /workspaces/PassionMafia/.env
```

2. Create the frontend `.env`. Note that this file is under the `react_main` subdirectory.

```
cp docs/client_env /workspaces/PassionMafia/react_main/.env
```
...
<img src="https://github.com/PassionMafia/PassionMafia/assets/24848927/8b55358f-6da7-4407-8b1c-c07e6dbc1394" alt="ports" width="300"/>
...
<img src="https://github.com/PassionMafia/PassionMafia/assets/24848927/cc9ac2e8-bde6-4014-b607-384ce414ef2f" alt="open in browse" width="300"/>

This account is not affiliated to `PassionMafia.io`. If your email domain is not accepted, look for the email section in both `.env` files.
...
3. Enter the PassionMafia collection.

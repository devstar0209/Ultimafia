  ...
  try {
    ...
    res.send({
      ...
      defaultSettings: {
        ...
        entryPrizePoolPercent: defaultSettings?.entryPrizePoolPercent ?? 70,
  ...
  try {
    ...
    const updated = await models.DefaultSettings.findOneAndUpdate(
      { key: "default" },
      {
        ...
        entryPrizePoolPercent: Math.max(
          0,
          Math.min(100, Number(entryPrizePoolPercent ?? 70))
        ),
    ...
    res.send({
      defaultSettings: {
        ...
        entryPrizePoolPercent: updated.entryPrizePoolPercent,
